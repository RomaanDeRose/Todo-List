    ...
    <div className="bg-gray-900 min-h-screen text-center text-purple-500 py-1">
      ...
      <form action="" className="w-4/5 mx-auto max-w-sm font-medium">
        <input
          value={newToDo}
          type="text"
          className="w-full bg-transparent font-medium mt-1 mb-4 py-3 px-3 border-4 border-purple-500 rounded-2xl shadow-lg text-1xl placeholder-purple-500/60 transition-all focus:outline-none shadow-purple-500/30"
